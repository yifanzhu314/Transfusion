...
class GPUConfig
{
    ...
    private:
        ...
        icpStepMap["GeForce RTX 3080"] = std::pair<int, int>(160, 256);
        rgbStepMap["GeForce RTX 3080"] = std::pair<int, int>(352, 64);
        rgbResMap["GeForce RTX 3080"] = std::pair<int, int>(256, 272);
        so3StepMap["GeForce RTX 3080"] = std::pair<int, int>(288, 128);


	    icpStepMap["GeForce 940MX"] = std::pair<int, int>(64, 48);
	    rgbStepMap["GeForce 940MX"] = std::pair<int, int>(64, 48);
	    rgbResMap["GeForce 940MX"] = std::pair<int, int>(128, 448);
	    so3StepMap["GeForce 940MX"] = std::pair<int, int>(32, 48);

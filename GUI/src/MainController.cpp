   ...
   resizeStream(0)
{
    ...
    else
    {
        ...
        Intrinsics::getInstance(520.908620, 521.007327, 325.141442, 249.701764);
        // Intrinsics::getInstance(543.5398336495659, 542.6830710361231, 308.9175740440219, 232.58239128959642);
        // Intrinsics::getInstance(603.7350463867188,603.2606811523438,  316.3616638183594,  231.890060424804);
    }
